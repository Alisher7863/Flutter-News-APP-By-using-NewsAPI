import 'package:bashorts_news_app/screens/loading_screen.dart';
import 'package:bashorts_news_app/view_model/articales_view_model.dart';
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Container(
            ...
            child: Scaffold(
              ...
              body: Swiper(
                scrollDirection: Axis.vertical, // Display cards vertically
                  ...
                  return InkWell(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.fromLTRB(0, 260.0, 0.0, 0),
                          child: SizedBox(
                            height: 150.0,
                            width: 750.0,
                            child: Material(
